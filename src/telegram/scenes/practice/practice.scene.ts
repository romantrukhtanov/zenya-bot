...
export class PracticeWizard extends BaseWizardScene<PracticeWizardContext> {
	...
	async onChapterSelect(@Ctx() ctx: PracticeWizardContext): Promise<void> {
		...
		const backToChaptersButton = Markup.button.callback(
			translations.scenes.practice.backToChapters,
			PracticeCallback.BackToChapters,
		);
	...
	async onCategorySelect(@Ctx() ctx: PracticeWizardContext): Promise<void> {
		...
		const backToCategoriesButton = Markup.button.callback(
			translations.scenes.practice.backToCategories,
			PracticeCallback.BackToCategories,
		);
	...
	async onPracticeSelect(@Ctx() ctx: PracticeWizardContext): Promise<void> {
		...
		const backToPracticesButton = Markup.button.callback(
			translations.scenes.practice.backToPractices,
			PracticeCallback.BackToPractices,
		);
	...
	async onInterestingFacts(@Ctx() ctx: PracticeWizardContext): Promise<void> {
		...
		const backButton = Markup.button.callback(
			translations.scenes.practice.backToCategory,
			PracticeCallback.BackToCategories,
		);
