...
export class PaymentService extends PaymentUtils {
  ...
  async createInvoiceRecord(orderId: string, userId: string, amountMinor: number, currency: Currency, provider: PaymentProvider) {
   ...
   * -----------------------------------------------------------------*/
  async markPaymentSucceeded(orderId: string, providerPaymentChargeId: string, telegramPaymentChargeId: string, subscriptionId?: string) {
