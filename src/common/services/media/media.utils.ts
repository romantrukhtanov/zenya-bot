...
export abstract class MediaUtils {
  ...
  protected replyWithVideo(ctx: Context | number, video: string | InputFile, extra: ExtraOptions = {}) {
  ...
  protected replyWithPhoto(ctx: Context | number, photo: string | InputFile, extra: ExtraOptions = {}) {
    const options = buildExtraOptions(extra);
  ...
  protected replyWithDocument(ctx: Context | number, file: string | InputFile, extra: ExtraOptions = {}) {
    const options = buildExtraOptions(extra);
